...
export const createYouthRecordSchema = z.object({
  ...
  is_registered_voter: z.boolean().nullable().default(false),
  voted_last_election: z.boolean().nullable().default(false),
  attended_kk_assembly: z.boolean().nullable().default(false),
