...
export type DemographicsReport = components['schemas']['DemographicsReport'];
...
export type ReferenceGroup = components['schemas']['ReferenceGroup'];
export type ReferenceOption = components['schemas']['ReferenceOption'];
export type CreateReferenceOptionInput = components['schemas']['CreateReferenceOptionInput'];
export type UpdateReferenceOptionInput = components['schemas']['UpdateReferenceOptionInput'];
